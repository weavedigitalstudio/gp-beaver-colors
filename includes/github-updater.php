<?php
/**
 * GitHub Update Checker for GP Beaver Colors
 *
...
class GPBC_GitHub_Updater {
    private $file;
    private $plugin;
    private $basename;
    private $github_response;
    private $github_username = "weavedigitalstudio";
    private $github_repo = "gp-beaver-colors";
    ...
    private const CACHE_KEY = 'gpbc_github_response';
    ...
    public function plugin_info($res, $action, $args) {
        ...
        $info->sections = [
            "description" => $plugin_data["Description"] ?? "Integrates GeneratePress Global Colors with Beaver Builder's color picker for consistent branding.",
